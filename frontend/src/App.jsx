  ...
  return (
    <div className="authwrap">
      <div className="authcard">
        <div className="brandbig"><div className="mark"><Heartbeat /></div><div className="wm">HealthQuest</div></div>
...
function ProfilePage({ s, onLogout }) {
  ...
  return (<>
    <div className="topbar"><div className="hello"><h1>Your profile</h1><p>Everything HealthQuest uses to tailor your journey.</p></div></div>
...
const SUGGESTIONS = [
  ...
  "How do streaks work in HealthQuest?",
...
function AssistantPage({ userName }) {
  ...
  return (
    <>
      <div className="topbar">
        <div className="hello"><h1>Health coach</h1><p>Grounded in HealthQuest's vetted wellbeing knowledge base.</p></div>
        ...
        <div className="chatscroll" ref={scrollRef}>
          {messages.length === 0 && (
            <div className="msg bot">
              Hi {userName || "there"} 👋 I'm your HealthQuest coach. I can help with hydration, movement, sleep, nutrition, stress, and how the app works — always grounded in verified wellbeing info. What's on your mind?
...
export default function App() {
  ...
  if (phase === "loading") return (
    <div className="healthquest-root"><div style={{ minHeight: "100vh", display: "grid", placeItems: "center" }}>
  ...
  if (phase === "auth") return <div className="healthquest-root"><Auth onDone={loadState} /></div>;
  if (phase === "onboarding") return <div className="healthquest-root"><Onboarding onDone={loadState} /></div>;
  ...
  return (
    <div className="healthquest-root">
      <div className="shell">
        <nav className="rail">
